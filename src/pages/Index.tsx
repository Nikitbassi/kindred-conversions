...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-hero">
      ...
      <section className="container mx-auto px-4 sm:px-6 pt-8 sm:pt-12 pb-12 sm:pb-20">
        <div className="max-w-5xl mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-6 sm:mb-8 max-w-3xl mx-auto px-2">Join 10,000+ people who've stopped settling and started winning in life, career, and relationships.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-4 sm:mb-6 animate-scale-in">
            <Button size="lg" className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 bg-gradient-accent shadow-glow hover:scale-105 transition-transform w-full sm:w-auto" onClick={handleJoinNow}>
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto relative">
              ...
              <div className="absolute left-5 sm:left-6 top-6 bottom-6 w-0.5 bg-gradient-to-b from-primary/40 via-primary/60 to-primary/40"></div>
              ...
              <div className="space-y-6 sm:space-y-8 relative">
                {[
                  ...
                  <div 
                    key={index}
                    className="flex items-center gap-4 sm:gap-5 opacity-0 animate-fade-in"
                    style={{ 
                  ...
                  >
                    {/* Dot */}
                    <div className="relative z-10 flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-primary flex items-center justify-center shadow-lg ring-4 ring-background group-hover:scale-110 transition-transform">
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16 items-start">
                ...
                <div className="flex justify-center lg:justify-start gap-4 relative">
                  ...
                  <div className="relative transform rotate-3 mt-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 mb-12 lg:mb-16 items-center">
                ...
                <div className="flex justify-center lg:justify-end">
                  <div className="bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-6 sm:p-8 rounded-2xl shadow-2xl border border-border/50">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <Button size="lg" className="text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 bg-gradient-accent shadow-glow hover:scale-105 transition-transform w-full sm:w-auto" onClick={handleJoinNow}>
                Claim Your Spot Now
                <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </Button>
            </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-center">Hear from Our Community</h2>
          <p className="text-center text-sm sm:text-base text-muted-foreground mb-8 sm:mb-12">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="bg-gradient-card border-2 border-primary/30 rounded-xl sm:rounded-2xl p-6 sm:p-8 shadow-glow text-center">
              ...
              <div className="flex items-start gap-2 sm:gap-3 text-left max-w-2xl mx-auto mb-4 sm:mb-6">
                ...
                <p className="text-sm sm:text-base text-muted-foreground">That's right - if you complete the courses and engage with the community, and you're not moved, you'll walk away with ₹9,990. We take all the risk.</p>
              </div>
      ...
      <section className="py-12 sm:py-16 md:py-20">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Button size="lg" className="text-base sm:text-lg md:text-xl px-8 sm:px-12 md:px-16 py-6 sm:py-8 bg-gradient-accent shadow-glow hover:scale-105 transition-transform w-full sm:w-auto" onClick={handleJoinNow}>
              Join The Inner Circle Now
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-card">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-bold mb-6 sm:mb-8">
              What will you choose?
            </p>
            
            <Button size="lg" className="text-base sm:text-lg md:text-xl px-8 sm:px-12 md:px-16 py-6 sm:py-8 bg-gradient-accent shadow-glow hover:scale-105 transition-transform mb-4 sm:mb-6 w-full sm:w-auto" onClick={handleJoinNow}>
